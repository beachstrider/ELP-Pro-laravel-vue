                    ...
                    <div class="row">
                        <div class="col-8">
                            <h5 class="mt-3 ml-0 mr-3 mb-2">
                                <strong>
                                    <template v-if="operation === null">{{$t('title.routes')}}</template>
                                    ...
                                    <b-row>
                                        ...
                                        <b-col sm="12">
                                            <b-form-group
                                                ...
                                                :invalid-feedback="formErrors.first('from_location')"
                                            >
                                                <b-form-input
                                                    id="from_location"
                                                    v-model="formFields.from_location"
                                                    type="text"
                                                    :state="((formErrors.has('from_location') ? false : null))"
                                                    ref="from_location"
                                                    @focus="$event.target.select()"
                                                ></b-form-input>
                                            </b-form-group>
                                        ...
                                        <b-col sm="12">
                                            <b-form-group
                                                ...
                                                :invalid-feedback="formErrors.first('to_location')"
                                            >
                                                <b-form-input
                                                    id="to_location"
                                                    v-model="formFields.to_location"
                                                    type="text"
                                                    :state="((formErrors.has('to_location') ? false : null))"
                                                    ref="to_location"
                                                    @focus="$event.target.select()"
                                                ></b-form-input>
                                            </b-form-group>
